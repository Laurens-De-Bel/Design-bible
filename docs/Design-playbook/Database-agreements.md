...
![Base color options in the Part Properties dialog](../assets/design-playbook/database-agreements/image89.png){ width="280" }
...
![Instance/surface color example](../assets/design-playbook/database-agreements/image90.png){ width="300" }
