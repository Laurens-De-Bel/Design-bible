...
![Corrupted part shown with cyan coloured faces](../assets/design-playbook/corrupt-parts/image10.png){ .center }

Transparent faces can also be an indication of face parts that can cause corruption.

![Part with transparent faces](../assets/design-playbook/corrupt-parts/image11.png){ .center }
...
![The 'Check Part' function in the toolbar](../assets/design-playbook/corrupt-parts/image13.png){ .center }
...
![Performing a Maximal check on a part](../assets/design-playbook/corrupt-parts/image15.png){ .center }

Make sure to keep the 'labels' checked on to view where the problem occurs.

![Labels enabled showing where the problem occurs](../assets/design-playbook/corrupt-parts/image16.png){ .center }
...
![System remark advising to check the part again](../assets/design-playbook/corrupt-parts/image17.png){ .center }

If you check it again, you might get lucky and the system will have successfully healed it.

![Part successfully healed after a second check](../assets/design-playbook/corrupt-parts/image18.png){ .center }
...
- **STEP**
    ...
    <div class="image-row">
        <img src="../../assets/design-playbook/corrupt-parts/image21.png" alt="Modelling settings for loading a step file" width="510">
        <img src="../../assets/design-playbook/corrupt-parts/image22.png" alt="Modelling settings for loading a step file, continued">
    </div>
...
![Resolution setting under part properties](../assets/design-playbook/corrupt-parts/image24.png){ .center }
...
- **Cut faces**
    ...
    ![Example of cut faces tool](../assets/design-playbook/corrupt-parts/image25.png){ .center }
...
- **Cut logos and details**
    ...
    <div class="image-row">
        <img src="../../assets/design-playbook/corrupt-parts/image29.png" alt="Logo and detail removed using the cut tool" width="455" height="300">
        <img src="../../assets/design-playbook/corrupt-parts/image30.png" alt="Detail removed using the cut tool, continued" width="194" height="300">
    </div>
...
- **Removing edges, roundings and void shells**
    ...
    ![Edges and roundings removed from a part](../assets/design-playbook/corrupt-parts/image31.png){ .center }
    ![Void shells inside a part](../assets/design-playbook/corrupt-parts/image32.png){ .center }
...
- **Too much detail**
    ...
    ![Part with excessive detail](../assets/design-playbook/corrupt-parts/image33.png){ .center }
    ![Part after removing excessive detail](../assets/design-playbook/corrupt-parts/image34.png){ .center }
...
- **Face parts**
    ...
    - **'Show Gaps'** will indicate where a face is missing and highlight it with orange edges.
        ...
        ![The 'Show Gaps' function highlighting a missing face](../assets/design-playbook/corrupt-parts/image37.png){ .center }
    ...
    - Sometimes it's advised to delete surfaces that are causing the problems. The **'Delete Face'** tool can be used to delete as many faces as required.
        ...
        ![The 'Delete Face' tool in use](../assets/design-playbook/corrupt-parts/image39.png){ .center }
    ...
    - With the **'Insert Face'** tool, you generate a face where one was previously deleted, by pressing the 'shift' key and selecting the edges until you connect a loop where the face is missing.
        ...
        ![Using 'Insert Face' to close a loop of edges](../assets/design-playbook/corrupt-parts/image41.png){ .center }
        ![Face inserted after connecting the loop](../assets/design-playbook/corrupt-parts/image42.png){ .center }
...
- **Part corruption too complex to solve**
    ...
    ![Different encoder model variations compared](../assets/design-playbook/corrupt-parts/image45.png){ .center }
    ...
    ![Part contour sketched and extruded as a last resort](../assets/design-playbook/corrupt-parts/image46.png){ .center }
...
- **Removing unnecessary assemblies, face parts and containers**
    ...
    ![Redundant assembly removed and renamed](../assets/design-playbook/corrupt-parts/image47.png){ .center }
...
- **Keep it simple**
    ...
    - If the article doesn't contain specific details that are mechanically important, it is appropriate to save it as a part. By using the **'Unite'** function, you can glue different parts together as one.
        ...
        ![Using 'Unite' to combine parts into one](../assets/design-playbook/corrupt-parts/image49.png){ .center }
    ...
    - If the article does contain specific details that are mechanically important, it is appropriate to save it as an assembly and set the assembly as inseparable. By using the **'Inseparable'** function, you force the system to only generate an article number for the assembly and not the underlying parts.
        ...
        ![Using 'Inseparable' to set an assembly](../assets/design-playbook/corrupt-parts/image51.png){ .center }
        ...
        ![Encoder, bracket and fasteners kept as one inseparable assembly](../assets/design-playbook/corrupt-parts/image52.png){ .center }

## Healing step by step

![Corrupted part healing process, step by step](../assets/design-playbook/corrupt-parts/image53.png){ .center }
